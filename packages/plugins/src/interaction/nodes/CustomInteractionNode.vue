<template>
  <div 
    class="bg-slate-900/85 backdrop-blur-[12px] border border-[#FF3B30]/30 rounded-xl cursor-pointer box-border relative select-none shadow-[0_4px_20px_rgba(255,59,48,0.4),inset_0_0_15px_rgba(255,59,48,0.05)] transition-all duration-300 ease-out hover:shadow-[0_8px_30px_rgba(255,59,48,0.6),inset_0_0_20px_rgba(255,59,48,0.1)] hover:border-[#FF3B30]/60 hover:-translate-y-[2px]" 
    :class="[data.selected ? '!border-[#FF3B30] shadow-[0_0_0_2px_rgba(255,59,48,0.4),0_8px_30px_rgba(255,59,48,0.6)]' : '']" 
    :style="nodeStyles()" 
    data-testid="node"
  >
    <!-- Header with Icon -->
    <div class="flex items-center bg-gradient-to-r from-[#FF3B30]/15 to-[#FF3B30]/5 border-b border-[#FF3B30]/20 px-[14px] py-[10px] gap-[10px] rounded-t-xl">
      <div class="w-6 h-6 text-[#FF3B30] flex items-center justify-center animate-[pulse_2s_cubic-bezier(0.4,0,0.6,1)_infinite]">
        <!-- SVG Gear Icon -->
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-full h-full drop-shadow-[0_0_4px_rgba(255,59,48,0.6)]"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"></path></svg>
      </div>
      <div class="text-[#FF3B30] font-sans text-[15px] font-semibold tracking-wide uppercase" data-testid="title">{{ data.label }}</div>
    </div>
