<template>
  <div 
    class="bg-slate-900/85 backdrop-blur-[12px] border border-blue-400/30 rounded-xl cursor-pointer box-border relative select-none shadow-[0_4px_20px_rgba(175,82,222,0.4),inset_0_0_15px_rgba(175,82,222,0.05)] transition-all duration-300 ease-out hover:shadow-[0_8px_30px_rgba(175,82,222,0.6),inset_0_0_20px_rgba(175,82,222,0.1)] hover:border-blue-400/60 hover:-translate-y-[2px]" 
    :class="[data.selected ? '!border-blue-400 shadow-[0_0_0_2px_rgba(175,82,222,0.4),0_8px_30px_rgba(175,82,222,0.6)]' : '']" 
    :style="nodeStyles()" 
    data-testid="node"
  >
    <!-- Header with Icon -->
    <div class="flex items-center bg-gradient-to-r from-blue-500/15 to-blue-500/5 border-b border-blue-400/20 px-[14px] py-[10px] gap-[10px] rounded-t-xl">
      <div class="w-6 h-6 text-blue-400 flex items-center justify-center">
        <!-- SVG Gear Icon -->
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-full h-full drop-shadow-[0_0_4px_rgba(175,82,222,0.6)]"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"></path><circle cx="12" cy="13" r="4"></circle></svg>
      </div>
      <div class="text-blue-100 font-sans text-[15px] font-semibold tracking-wide uppercase" data-testid="title">{{ data.label }}</div>
    </div>
...
:deep(.select-control select) {
  background: rgba(175,82,222, 0.6) !important;
  border: 1px solid rgba(175,82,222, 0.4) !important;
  color: #38bdf8 !important;
  font-weight: 600;
}
:deep(.select-control select:focus) {
  box-shadow: 0 0 0 2px rgba(175,82,222, 0.2) !important;
}
</style>
