<template>
  <div 
    class="bg-slate-900/85 backdrop-blur-[12px] border border-fuchsia-400/30 rounded-xl cursor-pointer box-border relative select-none shadow-[0_4px_20px_rgba(255,149,0,0.4),inset_0_0_15px_rgba(255,149,0,0.05)] transition-all duration-300 ease-out hover:shadow-[0_8px_30px_rgba(255,149,0,0.6),inset_0_0_20px_rgba(255,149,0,0.1)] hover:border-fuchsia-400/60 hover:-translate-y-[2px]" 
    :class="[data.selected ? '!border-fuchsia-400 shadow-[0_0_0_2px_rgba(255,149,0,0.4),0_8px_30px_rgba(255,149,0,0.6)]' : '']" 
    :style="nodeStyles()" 
    data-testid="node"
  >
    <!-- Header with Icon -->
    <div class="flex items-center bg-gradient-to-r from-fuchsia-500/15 to-fuchsia-500/5 border-b border-fuchsia-400/20 px-[14px] py-[10px] gap-[10px] rounded-t-xl">
      <div class="w-6 h-6 text-fuchsia-400 flex items-center justify-center">
        <!-- SVG Gear Icon -->
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-full h-full drop-shadow-[0_0_4px_rgba(255,149,0,0.6)]"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>
      </div>
      <div class="text-fuchsia-100 font-sans text-[15px] font-semibold tracking-wide uppercase" data-testid="title">{{ data.label }}</div>
    </div>
