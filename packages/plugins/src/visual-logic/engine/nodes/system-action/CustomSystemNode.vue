<template>
  <div 
    class="bg-slate-900/85 backdrop-blur-[12px] border border-sky-400/30 rounded-xl cursor-pointer box-border relative select-none shadow-[0_4px_20px_rgba(0,0,0,0.4),inset_0_0_15px_rgba(56,189,248,0.05)] transition-all duration-300 ease-out overflow-hidden hover:shadow-[0_8px_30px_rgba(0,0,0,0.6),inset_0_0_20px_rgba(56,189,248,0.1)] hover:border-sky-400/60 hover:-translate-y-[2px]" 
    :class="[data.selected ? '!border-sky-400 shadow-[0_0_0_2px_rgba(56,189,248,0.4),0_8px_30px_rgba(0,0,0,0.6)]' : '']" 
    :style="nodeStyles()" 
    data-testid="node"
  >
    <!-- Header with Icon -->
    <div class="flex items-center bg-gradient-to-r from-sky-500/15 to-sky-500/5 border-b border-sky-400/20 px-[14px] py-[10px] gap-[10px]">
      <div class="w-6 h-6 text-sky-400 flex items-center justify-center animate-[spin_8s_linear_infinite]">
        <!-- SVG Gear Icon -->
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-full h-full drop-shadow-[0_0_4px_rgba(56,189,248,0.6)]">
